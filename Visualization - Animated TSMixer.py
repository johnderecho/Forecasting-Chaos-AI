...
# ===================== CONFIG =====================
RESULTS_PATH = r"C:\Users\Windows\Desktop\Thesis - GPU\results\MLP TSMixer - Lorenz - 50.json"
...
def main():
    ...
    y_pred = np.array(results[attractor_name]["TSMixer_final"]["prediction"])
    ...
    # Output path as .gif
    save_path = os.path.join(OUTPUT_DIR, f"TSMixer {attractor_name}_animation.gif")

    animate_phase_space_3d(y_true, y_pred, attractor_name=f"{attractor_name} (GT vs TSMixer)",
                           save_path=save_path)
