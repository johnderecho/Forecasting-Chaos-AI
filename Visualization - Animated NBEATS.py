...
# ===================== CONFIG =====================
RESULTS_PATH = r"C:\Users\Windows\Desktop\Thesis - GPU\results\MLP NBEATS - Lorenz - 50.json"
...
def main():
    ...
    y_pred = np.array(results[attractor_name]["NBEATS_final"]["prediction"])
    ...
    # Output path as .gif
    save_path = os.path.join(OUTPUT_DIR, f"NBEATS{attractor_name}_animation.gif")

    animate_phase_space_3d(y_true, y_pred, attractor_name=f"{attractor_name} (GT vs NBEATS)",
                           save_path=save_path)
